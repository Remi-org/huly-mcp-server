import { Account, AggregateValue, AnyAttribute, CategoryType, Class, Client, Doc, DocManager, DocumentQuery, FindOptions, Hierarchy, Lookup, Mixin, Obj, ObjQueryType, PrimitiveType, Ref, SortingOrder, Space, Tx, TxOperations, Type, UXObject } from '@hcengineering/core';
import { Asset, IntlString, Resource, Status } from '@hcengineering/platform';
import { Preference } from '@hcengineering/preference';
import { AnyComponent, AnySvelteComponent, Location, Location as PlatformLocation, type LabelAndProps } from '@hcengineering/ui';
/**
 * @public
 */
 ...
 * @public
 */
export type SortFunc = Resource<(client: TxOperations, values: PrimitiveType[], space: Ref<Space> | undefined, viewletDescriptorId?: Ref<ViewletDescriptor>) => Promise<any[]>>;
/**
 * @public
 */
 ...
 * @public
 */
export type GetAllValuesFunc = Resource<(query: DocumentQuery<Doc> | undefined, onUpdate: () => void, queryId: Ref<Doc>, attr: AnyAttribute) => Promise<any[] | undefined>>;
/**
 * @public
 */
...
export interface GrouppingManager {
    ...
    groupValuesWithEmpty: (hierarchy: Hierarchy, _class: Ref<Class<Doc>>, key: string, query: DocumentQuery<Doc> | undefined) => Array<Ref<Doc>>;
 ...
 * @public
 */
export type CreateAggregationManagerFunc = Resource<(client: Client, lqCallback: () => void, setStore: (manager: DocManager<any>) => void, categorizingFunc: (doc: any, target: any) => boolean, _class: Ref<Class<any>>) => IAggregationManager<any>>;
/**
 * @public
 */
 ...
 * @public
 */
export type ViewActionFunction<T extends Doc = Doc, P = Record<string, any>> = (doc: T | T[] | undefined, evt?: Event, params?: P) => Promise<void>;
/**
 * @public
 */
 ...
 * @public
 */
export type ViewOptionsAction<T extends Doc = Doc> = Resource<(value: any, query: FindOptions<T> | undefined) => FindOptions<T>>;
/**
 * @public
 */
 ...
 * @public
 */
export type ViewCategoryActionFunc = (_class: Ref<Class<Doc>>, query: DocumentQuery<Doc> | undefined, space: Ref<Space> | undefined, key: string, onUpdate: () => void, queryId: Ref<Doc>, viewletDescriptorId?: Ref<ViewletDescriptor>) => Promise<CategoryType[] | undefined>;
/**
 * @public
 */
 ...
 * @public
 */
export type ViewQueryAction = Resource<(value: any, query: DocumentQuery<Doc>) => DocumentQuery<Doc> | Promise<DocumentQuery<Doc>>>;
/**
 * @public
 */
...
export declare const AttributeCategoryOrder: Record<AttributeCategory, number>;
